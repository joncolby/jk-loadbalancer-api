            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="host.frontends.label" default="Frontends" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="host.ipAddress.label" default="Ip Address" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: hostInstance, field: "ipAddress")}</td>
